...
void Profiles::Setup::MapData(CtrlMapper& m, Profile& p) const
{
	...
	(visuals.delayedrefresh,   p.delayedrefresh)
	(visuals.lazyresize,       p.lazyresize)
	(visuals.textreflow,       p.textreflow)
